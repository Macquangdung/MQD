<?php
    ...
    $select_category_id = $get_data->select_category_id($_GET['sua']);
    foreach($select_category_id as $i_sp):
?>
<!DOCTYPE html>
...
<body>
   ...
   <form role="form" method="post" action="../CONTROLLER/controlcategory.php?sua=<?php echo $_GET['sua']?>">
                                    <div class="form-group">
                                        <label>Tên danh mục</label>
                                        <input class="form-control" type="text" name="txtname" value="<?php echo $i_sp['name']?>" required>
                                        <p class="help-block">Nhập tên danh mục</p>
                                    </div>

                                    <div class="form-group">
                                        <label>Mô tả</label>
                                        <textarea class="form-control" rows="3" name="txtdesc" required><?php echo $i_sp['description']?></textarea>
